...
public class LargestDivisibleSubset {
    ...
    public static List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        while (maxValIndex != -1) {
            result.add(0, nums[maxValIndex]);
            maxValIndex = parent[maxValIndex];
        }
        return result;
    }
}
